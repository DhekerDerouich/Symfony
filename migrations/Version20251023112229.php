 ...
 */
final class Version20251023112229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE author_id author_id INT DEFAULT NULL, CHANGE publication_date publication_date DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE author_id author_id INT NOT NULL, CHANGE publication_date publication_date DATETIME NOT NULL');
    }
}
